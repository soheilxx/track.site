...
/**
 * English (source language) copy of the features area. Same shape as every other locale file; see docs/14-localization.md.
 */

export const FEATURES_EN: FeatureCopy[] = [
  {
    slug: "ai-setup",
...
export const FEATURES_PAGE_COPY_EN: FeaturesPageCopy = {
  eyebrow: "Features",
...
export const FEATURE_DETAIL_COPY_EN: FeatureDetailLabels = {
  features: "Features",
...
export const FEATURE_UI_COPY_EN: FeatureUiCopy = {
