 ...
 * Mounted through `ArticleFeedback` (feedback.tsx), which applies the `knowledge.feedback` flag.
 */
export function ArticleFeedbackForm({ translationGroupId, locale, labels }: { translationGroupId: string; locale: string; labels: FeedbackLabels }) {
