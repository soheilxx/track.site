/**
 * Label helpers of the support macros / settings slice (namespace `supportMacros`). `t` is the namespace
 * translator; unknown codes fall back to the generic message so nothing hides behind a missing key.
 */
