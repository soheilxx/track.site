...
/** Calendar day of a front-matter date ("2026-09-03" → "3 September 2026"); null for a missing or invalid value. */
...
/** Date + time for build times and vote timestamps, on top of `lib/format.ts` (which covers dates only). */
...
/** "3 days ago" relative to `now` (ms since epoch), so server and client render the same string. */
