import { generateStaticParams as cardParams, renderKnowledgeIndexSocialCard } from "../card";

/**
 * Stable URL of the generated 1200×630 social card (one per locale):
...
export async function GET(_request: Request, ctx: { params: Promise<{ locale: string }> }) {
  return renderKnowledgeIndexSocialCard(ctx);
}
