...
description: "Was der TC-String des IAB TCF 2.2, der Global-Privacy-Platform-String und der Global-Privacy-Control-Header jeweils ausdrücken, wie sie auf Zwecke wie Analytics und Marketing abgebildet werden und wie track.site sie je Event auswertet, ohne je Consent anzunehmen."
...
track.site normalisiert jedes Signal auf vier Zwecke: `necessary`, `analytics`, `marketing`, `personalization`. Die Zuordnung ist konservativ — ein Zweck gilt nur als erteilt, wenn das Signal ihn positiv erteilt:
