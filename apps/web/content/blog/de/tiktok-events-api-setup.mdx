...
TikTok dedupliziert über `event_id`, wenn derselbe Eventname vom Pixel (`ttq.track('CompletePayment', {...}, { event_id })`) und von der API innerhalb des Dedup-Fensters eintrifft. Erzeuge eine ID pro Aktion und gib sie beiden mit; das track.site-SDK macht das automatisch für jedes gespiegelte Event.
