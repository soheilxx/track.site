...
description: "Wie sich die track.site-Shopware-App registriert, welche Bestellereignisse auf purchase und refund abgebildet werden, wie die shopware-shop-signature verifiziert wird, warum der Transaktionsstatus „bezahlt“ die aufgegebene Bestellung schlägt und wo das Snippet im Theme hingehört."
excerpt: "Shopware 6s App-System liefert signierte Webhooks, ohne PHP in den Shop zu bringen. Die track.site-App abonniert die Transaktionsstatus bezahlt und erstattet, der Collector verifiziert jede Zustellung, und das Storefront-Snippet deckt die Browser-Seite ab. Hier ist der ganze Weg."
