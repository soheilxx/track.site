...
- Füge die Domain in den Site-Einstellungen hinzu. track.site stellt einen **Verifikations-Token** aus; weise die Kontrolle per DNS-TXT-Eintrag, Datei auf der Domain oder Meta-Tag nach. Die Domain wird erst aktiv, wenn die Verifikation gelingt, sodass niemand eine fremde Domain auf deine Site zeigen lassen kann.
...
track.site schreibt drei Dinge im Browser, jedes erst nach dem passenden Consent:
