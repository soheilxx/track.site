...
description: "Wie der Einrichtungsassistent von track.site so gebaut ist, dass er planen und konfigurieren, aber nie Code ausführen, Daten erfinden oder Consent umgehen kann — der Tool-Vertrag, serverseitige Validierung, Freigabe-Tokens, der Audit-Trail und was das Modell nie sieht."
