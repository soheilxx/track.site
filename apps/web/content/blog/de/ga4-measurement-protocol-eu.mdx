...
`POST https://www.google-analytics.com/mp/collect?measurement_id=G-XXXX&api_secret=…` ist der dokumentierte Sammel-Endpunkt. Google dokumentiert zudem `https://region1.google-analytics.com/mp/collect` für Traffic aus der EU; track.site nutzt standardmäßig den region1-Host, damit Requests in der EU entstehen und enden.
