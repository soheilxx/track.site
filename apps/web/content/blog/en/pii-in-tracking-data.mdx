...
description: "The common ways e-mails, phone numbers, card numbers and tokens end up in tracking events — URLs, page titles, form fields, search terms — and how track.site's PII scanner redacts, reports and, for cards and secrets, blocks before anything is stored or forwarded."
