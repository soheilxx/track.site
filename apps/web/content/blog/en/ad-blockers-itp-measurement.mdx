...
What it does not change: the anonymous id is written by the SDK under analytics or marketing consent, and Safari still caps script-written storage at seven days. Recognition of returning Safari visitors beyond that stays limited; track.site does not work around it.
