...
description: "track.site's canonical event catalogue — engagement, auth, lead, commerce and subscription events — with the properties each one carries, the consent purposes it needs by default and how it translates to Meta, Google, TikTok, LinkedIn and the rest."
