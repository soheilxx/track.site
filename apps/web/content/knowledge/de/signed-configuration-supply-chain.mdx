...
description: "Ein Tag-Manager liefert Code an jeden Besucher deiner Site. Track behandelt das als Lieferkette: deklarative Templates statt eigener Skripte, Ed25519-signierte Konfigurationsbundles, ein Manifest mit Digest und Key-ID, clientseitige Verifikation und eine Versionshistorie mit Rollback."
