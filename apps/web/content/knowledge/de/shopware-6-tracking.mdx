...
level: "intermediate"
takeaways:
  - "Die Track-App ist ein Manifest, kein Plugin: Shopware sendet signierte Webhooks, nichts von Track läuft im Shop, und die API-Zugangsdaten der Registrierung werden absichtlich verworfen."
  - "Standardmäßig wird der Transaktionsstatus „bezahlt“ zum Kauf und „erstattet“ zur Erstattung; Shops, bei denen die Aufgabe der maßgebliche Moment ist, stellen die Verbindung auf aufgegebene Bestellungen um."
  - "Eine fehlende Währung fällt auf die Einstellung der Verbindung zurück oder wird als fehlendes Feld gemeldet statt geraten."
  - "Das Storefront-Snippet in base.html.twig erzeugt den Browser-Kauf, dessen Consent der verifizierte Server-Kauf über die Bestellnummer erbt."
