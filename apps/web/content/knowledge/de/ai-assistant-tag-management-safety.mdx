...
level: "intermediate"
takeaways:
  - "Der Assistent lebt nur in der Control Plane: Er liest Konfiguration und Aggregate und schlägt Änderungen vor, während Collector, Router und Worker nie ein Modell aufrufen."
  - "Er handelt über typisierte, serverseitig validierte Tools mit Rollenprüfung; Veröffentlichen, Rollback, Pausieren und Rotieren von Zugangsdaten verlangen einen Freigabe-Token, den ein Mensch für genau diesen Diff ausstellt."
  - "Das Modell sieht nie Geheimnisse, rohe Events, personenbezogene Daten, andere Mandanten oder Anbieter-APIs und kann weder Code ausführen, Consent erteilen, Werte erfinden noch veröffentlichen."
  - "Jeder Tool-Aufruf landet im Audit-Log, sodass eine Änderung über den Assistenten nicht von einer manuellen zu unterscheiden ist."
