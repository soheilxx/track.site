...
description: "Wie Auskunfts- und Löschanfragen auf Eventdaten, Click-IDs, Consent-Einträge und Zustellprotokolle wirken; wie Track die betroffene Person über E-Mail, Nutzer-ID oder anonyme ID identifiziert; was der Export enthält; und was ein Löschjob absichtlich zurücklässt."
...
level: "intermediate"
takeaways:
  - "Tracking-Datensätze einer Person umfassen Events, Click-IDs, Consent-Einträge, Zustellversuche, Conversion-Datensätze und die Kopien bei den Anbietern."
  - "Die Person wird über den SHA-256-Hash der E-Mail, eine Nutzer-ID oder eine anonyme ID identifiziert — nie über die Klartext-E-Mail, die nicht gespeichert wird; „keine Datensätze gefunden“ ist ein legitimes Ergebnis."
  - "Export, Löschung, Einschränkung und Berichtigung erzeugen jeweils einen Audit-Eintrag und einen Abschlussbericht mit Zählwerten, nie mit gelöschtem Inhalt; Anfragen tragen eine Frist von 30 Tagen."
  - "Die Löschung behält absichtlich den Audit-Eintrag, aggregierte Statistiken und als Nachweis nötige Consent-Einträge und listet die Anbieter, die der Betreiber separat kontaktieren muss."
