...
description: "How Track computes the 0-100 health score from consent coverage, critical event coverage, schema quality, duplicate rate, delivery success and liveness — with the exact weights, what 'no data yet' scores, and what to fix first when the number drops."
