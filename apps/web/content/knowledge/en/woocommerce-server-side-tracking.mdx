...
description: "How the Track WooCommerce plugin installs the snippet, pushes a GA4-shaped purchase on the thank-you page and manages native WooCommerce webhooks signed with HMAC-SHA256 — and how orders, statuses and refunds map to canonical events."
