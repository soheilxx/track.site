...
import { DefaultLink, type LinkRenderer } from "./navigation.tsx";

/*
 * Pagination is a client component: it attaches click handlers for `onPageChange`, and `hrefFor` is a
 * function prop, so both variants are driven from client components (server-rendered lists pass
 * `linkComponent={Link}` and build hrefs on the client side of the boundary).
 */
