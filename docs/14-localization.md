...
| Plans and billing terms | Starter, Growth, Pro, Enterprise (plan names), EUR, "Consent Engine", "Live Event Debugger", "Tracking Health Score", "Data Quality Inbox", "Event Replay", "Config-Versionierung"-style module names follow the German precedent: product module names stay English, the explanation next to them is translated |
