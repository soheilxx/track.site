...
| `/app/settings` | Settings + Alerts & Incident Mode + AI motion preference (alerts module still open, see §5 phase 5) | `/app/settings`, `/app/settings/alerts` (pending) |
